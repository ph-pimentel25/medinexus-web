...
export default function ClinicaDashboardPage() {
  ...
  return (
    <main className="mn-dashboard min-h-screen bg-mn-sand">
      <DashboardOverview eyebrow="Gestão da clínica" title={`Olá, ${getFirstName(getClinicName(clinic))}.`} description="Uma visão clara da equipe, das consultas e do cuidado com seus pacientes." loading={loading}
        actions={[{label:"Ver consultas",href:"/clinica/solicitacoes"},{label:"Gerenciar equipe",href:"/clinica/medicos"}]}
        metrics={[{label:"Consultas recentes",value:summary.totalAppointments,hint:"Resumo dos atendimentos"},{label:"Médicos ativos",value:summary.activeDoctors,hint:"Sua equipe de atendimento"},{label:"Solicitações pendentes",value:summary.pending,hint:"Aguardando análise da clínica"},{label:"Consultas confirmadas",value:summary.confirmed,hint:"Próximos passos organizados"}]} />
