...
export default function HomePage() {
  return (
    <main className="min-h-screen overflow-hidden bg-mn-sand text-mn-graphite">
      <section className="relative min-h-[calc(100vh-104px)]">
        ...
        <div className="absolute left-1/2 top-0 h-px w-[92%] -translate-x-1/2 bg-gradient-to-r from-transparent via-mn-teal/25 to-transparent" />
        ...
        <div className="relative mx-auto grid min-h-[calc(100vh-104px)] max-w-[1500px] items-center gap-14 px-6 py-14 sm:px-10 lg:grid-cols-[1.03fr_0.97fr] lg:px-14">
          <div>
            <div className="mb-7 inline-flex items-center gap-3 rounded-full border border-mn-border bg-white/60 px-4 py-2 shadow-[0_24px_90px_-65px_rgba(46,57,63,0.55)] backdrop-blur-xl">
            ...
            <h1 className="max-w-6xl text-[4.2rem] font-semibold leading-[0.88] tracking-[-0.085em] text-mn-graphite sm:text-[6rem] lg:text-[7.6rem]">
              A saúde
              <br />
              finalmente
              <br />
            ...
            <p className="mt-8 max-w-2xl text-xl leading-9 text-mn-graphite/72">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                href="/cadastro"
                className="group inline-flex h-14 items-center justify-center rounded-full bg-mn-teal px-8 text-sm font-semibold text-white shadow-[0_24px_80px_-40px_rgba(22,73,87,0.85)] transition hover:-translate-y-0.5 hover:bg-[#123B46]"
              >
                Começar agora
              ...
              <Link
                href="/clinicas"
                className="inline-flex h-14 items-center justify-center rounded-full border border-mn-border bg-white/70 px-8 text-sm font-semibold text-mn-graphite shadow-sm backdrop-blur-xl transition hover:-translate-y-0.5 hover:bg-white"
              >
                Explorar a rede
              </Link>
            </div>
            ...
            <div className="mt-16 grid max-w-2xl grid-cols-3 gap-5">
              {[
                ...
                <div key={title} className="border-t border-mn-border pt-5">
                  <p className="text-base font-semibold text-mn-teal">
                    {title}
                  </p>
                  <p className="mt-1 text-sm leading-6 text-mn-graphite/58">
                    {text}
                  </p>
                </div>
              ))}
          ...
          <div className="relative">
            <div className="absolute -left-10 top-10 h-52 w-52 rounded-full bg-mn-sage/30 blur-3xl" />
            <div className="absolute -bottom-12 -right-10 h-64 w-64 rounded-full bg-mn-purple/25 blur-3xl" />
            ...
            <div className="relative rotate-[-1deg] rounded-[3.2rem] border border-white/75 bg-white/45 p-3 shadow-[0_55px_150px_-70px_rgba(46,57,63,0.85)] backdrop-blur-2xl">
              <div className="overflow-hidden rounded-[2.7rem] bg-mn-graphite">
                <div className="relative p-7 text-white sm:p-9">
                  <div className="absolute right-[-4rem] top-[-4rem] h-72 w-72 rounded-full bg-mn-purple/55 blur-3xl" />
                  <div className="absolute bottom-[-5rem] left-[-4rem] h-72 w-72 rounded-full bg-mn-sage/25 blur-3xl" />
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-8 rounded-2xl border border-white/10 bg-white/10 p-5 backdrop-blur">
                      <div className="flex flex-wrap items-start justify-between gap-4">
                        ...
                        <span className="rounded-full bg-mn-sage/25 px-3 py-1 text-xs font-semibold text-mn-sage-light">
                          Ao vivo
                        </span>
                      </div>

                      <div className="mt-6 h-2 overflow-hidden rounded-full bg-white/10">
                        <div className="h-full w-[76%] rounded-full bg-mn-sage" />
                      </div>
                    ...
                    <div className="mt-5 grid gap-3">
                      {journey.map((item) => (
                        <div
                          key={item.number}
                          className="grid grid-cols-[48px_1fr_auto] items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.06] p-4 backdrop-blur"
                        >
                          <div className="flex h-11 w-11 items-center justify-center rounded-full bg-white text-sm font-semibold text-mn-teal">
                            {item.number}
                          </div>
                          ...
                          <div className="h-2.5 w-2.5 rounded-full bg-mn-sage" />
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <div className="absolute -bottom-8 left-10 hidden rotate-[1deg] rounded-3xl border border-mn-border bg-white/85 p-5 shadow-[0_28px_85px_-55px_rgba(46,57,63,0.75)] backdrop-blur-xl lg:block">
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-mn-sage">
                Status
              </p>
              <p className="mt-2 text-lg font-semibold tracking-[-0.03em] text-mn-graphite">
      ...
      <section className="relative border-y border-mn-border bg-white/48">
        <div className="mx-auto grid max-w-[1500px] gap-12 px-6 py-20 sm:px-10 lg:grid-cols-[0.78fr_1.22fr] lg:px-14">
          ...
          <div className="grid gap-5 md:grid-cols-3">
            {[
              ...
              <article
                key={item.title}
                className="group rounded-2xl border border-mn-border bg-mn-sand/80 p-7 transition hover:-translate-y-1 hover:bg-white hover:shadow-[0_30px_90px_-65px_rgba(46,57,63,0.55)]"
              >
                <div className="mb-8 h-1.5 w-12 rounded-full bg-mn-sage transition group-hover:w-20" />
      ...
      <section className="mx-auto max-w-[1500px] px-6 py-20 sm:px-10 lg:px-14">
        <div className="grid gap-14 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
          <div className="relative">
            <div className="absolute -left-10 top-1/2 h-64 w-64 -translate-y-1/2 rounded-full bg-mn-sage-light blur-3xl" />

            <div className="relative grid gap-4">
              {modules.map((item, index) => (
                <div
                  key={item}
                  className="flex items-center gap-5 rounded-2xl border border-mn-border bg-white/70 p-5 shadow-sm backdrop-blur"
                >
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-mn-teal text-sm font-semibold text-white">
                    {String(index + 1).padStart(2, "0")}
                  </div>

                  <p className="text-lg font-medium tracking-[-0.025em] text-mn-graphite">
                    {item}
                  </p>
                </div>
              ))}
          ...
          <div>
            ...
            <h2 className="mt-5 text-5xl font-semibold leading-[1.02] tracking-[-0.065em] text-mn-graphite">
              Chega de atendimento espalhado em mensagens, prints e arquivos
              soltos.
            </h2>

            <p className="mt-7 max-w-2xl text-lg leading-9 text-mn-graphite/68">
            ...
            <div className="mt-9 flex flex-wrap gap-3">
              <Link
                href="/profissionais"
                className="rounded-full bg-mn-teal px-8 py-4 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[#123B46]"
              >
              ...
              <Link
                href="/pacotes"
                className="rounded-full border border-mn-border bg-white/70 px-8 py-4 text-sm font-semibold text-mn-graphite transition hover:-translate-y-0.5 hover:bg-white"
              >
                Ver pacotes
              </Link>
            </div>
