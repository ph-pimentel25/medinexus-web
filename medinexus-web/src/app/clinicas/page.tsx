...
function getClinicDescription(item: ClinicRow) {
  return (
    item.description ||
    "Clínica cadastrada na plataforma MediNexus para conexão entre pacientes, médicos e atendimentos."
  );
}
    ...
    <main className="min-h-screen bg-[#F6F8FC]">
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-10 sm:px-6 lg:flex-row lg:items-end lg:justify-between lg:px-8">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-base leading-7 text-slate-600">
              Encontre clínicas conectadas à plataforma e escolha o melhor ponto
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-3xl border border-[#E3E8F4] bg-white p-5 shadow-sm">
          ...
          <div className="rounded-3xl border border-[#E3E8F4] bg-white p-5 shadow-sm">
            ...
            <p className="mt-3 text-3xl font-bold text-[#283C7A]">
              {cities.length}
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-[#E3E8F4] bg-white p-5 shadow-sm">
            ...
            <p className="mt-3 text-3xl font-bold text-[#5E4B9A]">
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                  ...
                  <div className="flex shrink-0 flex-wrap gap-2 lg:max-w-[220px]">
                    <Link
                      ...
                      className="w-full rounded-2xl bg-[#283C7A] px-5 py-3 text-center text-sm font-semibold text-white transition hover:bg-[#22356E]"
                    >
                      Ver clínica
                    </Link>
